...
export const getUserById = async (userId: number): Promise<User> => {
  ...
  const endpoint = useAPI
    ...
    : `/mocksData/${userId}/userData.json`;
...
export const getActivityById = async (
  ...
  const endpoint = useAPI
    ...
    : `/mocksData/${userId}/userActivityData.json`;
...
export const getSessionsById = async (
  ...
  const endpoint = useAPI
    ...
    : `/mocksData/${userId}/userAverageSessionsData.json`;
...
export const getPerformanceById = async (
  ...
  const endpoint = useAPI
    ...
    : `/mocksData/${userId}/userPerformanceData.json`;
